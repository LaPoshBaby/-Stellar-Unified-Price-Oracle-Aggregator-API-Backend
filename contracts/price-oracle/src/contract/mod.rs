...
//   - utils.rs      — contract-side view over the shared helper module
//
// The shared helpers themselves (deviation_exceeds, update_reputation,
// calculate_usd_price, ...) live in crate::utils (Issue #298) so the proxy
// contract uses exactly the same implementations.
